...
class PartnersController extends Controller implements HasMiddleware
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            ->editColumn('image', function(TopCustomer $partner){
                return "<img src='" . asset($partner->display_image) ."' width='40' height='40' class='rounded-5'>";
            })
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('customer_image')) {
            ...
            $imagePath = 'partners/' . uniqid() . '.webp';
    ...
    public function update(Request $request, TopCustomer $partner)
    {
        ...
        if($request->hasFile('customer_image')) {
            if ($partner->customer_image && Storage::disk('public')->exists($partner->customer_image)) {
                Storage::disk('public')->delete($partner->customer_image);
            }
