...
<form id="edit-services-form" data-id="{{ $service->id }}">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="position-relative d-inline-block auto-image-show">
                                ...
                                <div class="avatar-lg">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="{{ $service->display_image }}" id="product-img" style="min-height: 100%;min-width: 100%;" />
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        let dropzone = new Dropzone(".dropzone", {
            ...
            init: function() {
                ...
                existingFiles.forEach(image => {
                    ...
                    this.emit("thumbnail", mockFile, image.file_path); // Show thumbnail
