                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="generalInfo" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="phone_number2">@lang('dashboard.phone_number2')</label>
                                        <input class="form-control" id="phone_number2" name="phone_number2" type="text" placeholder="@lang('dashboard.enter') @lang('dashboard.phone_number2')" value="{{ $website_settings->phone_number2 }}">
                                    </div>
                                </div>
                                <!--end col-->
