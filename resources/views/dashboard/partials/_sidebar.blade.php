<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box py-2">
        ...
        <a href="{{ route('dashboard.index') }}" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{ $website_settings->display_logo }}" alt="@lang('dashboard.logo_alt')" height="40">
            </span>
            <span class="logo-lg">
                <img src="{{ $website_settings->display_logo }}" alt="@lang('dashboard.logo_alt')" height="70">
            </span>
        </a>
        <!-- Light Logo-->
