        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ $website_settings->display_logo }}" alt="@lang('dashboard.logo_alt')" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ $website_settings->display_logo }}" alt="@lang('dashboard.logo_alt')" height="17">
                        </span>
                    </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <h6 class="dropdown-header">@lang('dashboard.welcome_user', ['name' => Auth::user()->name])</h6>
